========================================================================
    APPLICATION WIN32 : vue d'ensemble du projet CSRegister
========================================================================

AppWizard a créé cette application CSRegister pour vous.  
Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application CSRegister.
...
CSRegister.ico
    ...
    Cette icône est incluse par le fichier de ressources principal CSRegister.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé CSRegister.pch et un fichier de type précompilé nommé StdAfx.obj.
