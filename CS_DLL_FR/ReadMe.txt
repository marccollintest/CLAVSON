=========================================================================
    PROCÉDURE STOCKÉE ÉTENDUE : vue d'ensemble du projet CS_DLL_FR
========================================================================


AppWizard a créé CS_DLL_FR.dll pour vous.  

Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application CS_DLL_FR.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé CS_DLL_FR.pch et un fichier de type précompilé nommé StdAfx.obj.


/////////////////////////////////////////////////////////////////////////////
Autres remarques :

Après avoir terminé cet Assistant, copiez CS_DLL_FR.dll dans votre répertoire 
\Binn SQL Server.
...
SQL suivante :
  sp_addextendedproc 'xp_proc', 'CS_DLL_FR.DLL'
